    ...
    <section className="py-28 bg-ink overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {STANDARDS.map((item, i) => (
              <motion.div
                ...
                className="rounded-2xl bg-white/5 border border-white/10 p-6 hover:border-harvest/40 transition-colors"
              >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-14 rounded-2xl bg-harvest/10 border border-harvest/25 p-6"
        >
