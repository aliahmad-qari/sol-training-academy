...
export default function Footer() {
  ...
  return (
    <footer className="bg-ink text-white pt-16 md:pt-24 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Top — CTA Banner */}
        <div className="bg-harvest/10 border border-harvest/20 rounded-2xl p-6 sm:p-8 md:p-14 mb-12 md:mb-20 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-white/70 mt-2 text-base md:text-lg">Start with a free consultation today.</p>
          </div>
          <Link
            to="/#contact"
        ...
        {/* Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-10 md:mb-16">
          {/* Brand */}
          <div className="sm:col-span-2 md:col-span-4 lg:col-span-1 mb-4 lg:mb-0">
            ...
            <form onSubmit={handleNewsletterSubmit} className="mt-5 w-full max-w-xs space-y-2">
        ...
        {/* Contact Bar */}
        <div className="border-t border-white/10 pt-8 mb-4 flex flex-wrap gap-x-6 gap-y-3 text-xs text-white/70">
          <span>📞 <a href="tel:+61460003494" className="hover:text-harvest transition-colors">+61 460 003 494</a></span>
          <span>✉️ <a href="mailto:info@solbusinessconsultant.com.au" className="break-all hover:text-harvest transition-colors">info@solbusinessconsultant.com.au</a></span>
          <span>🌐 <a href="https://www.solbusinessconsultant.com.au" target="_blank" rel="noopener noreferrer" className="break-all hover:text-harvest transition-colors">www.solbusinessconsultant.com.au</a></span>
