...
export default function LearningStreak({ user, enrollments, quizAttempts }) {
  ...
  return (
    <div className="space-y-5">
      {/* Streak Hero */}
      <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-2xl p-5 sm:p-6 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
          <div className="text-center flex-shrink-0">
            <div className="flex items-center justify-center gap-2 mb-1">
              <Flame className="w-7 h-7 sm:w-8 sm:h-8 text-yellow-300" />
              <span className="font-display font-black text-4xl sm:text-5xl">{streakDays}</span>
            </div>
