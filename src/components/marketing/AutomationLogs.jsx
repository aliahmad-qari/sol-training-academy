  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-4">
        ...
        <p className="text-sm text-slate_mist">{filtered.length} log entries</p>
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-chalk border-b border-border">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate_mist uppercase tracking-wide">Business</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate_mist uppercase tracking-wide">Sequence</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate_mist uppercase tracking-wide">Subject</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate_mist uppercase tracking-wide">Sent To</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate_mist uppercase tracking-wide">Status</th>
                  <th className="px-4 py-3 text-left text-xs font-semibold text-slate_mist uppercase tracking-wide">Date</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border/50">
                {filtered.map(log => (
                  <tr key={log.id} className="hover:bg-chalk/50 transition-colors">
                    <td className="px-4 py-3 font-semibold text-ink">{log.business_name}</td>
                    <td className="px-4 py-3 text-slate_mist">{log.sequence_name}</td>
                    <td className="px-4 py-3 text-slate_mist max-w-xs truncate">{log.subject}</td>
                    <td className="px-4 py-3 text-xs text-slate_mist">{log.email_sent_to}</td>
